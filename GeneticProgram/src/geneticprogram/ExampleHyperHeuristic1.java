...
public class ExampleHyperHeuristic1 extends HyperHeuristic {
           ...
           */
          public ExampleHyperHeuristic1(long seed, Program prog) {
                    super(seed);
                    this.prog = prog;
          }
          ...
          public void solve(ProblemDomain problem) {
                    try {
                              ...
                              Logger.getLogger(ExampleHyperHeuristic1.class.getName()).log(Level.SEVERE, null, ex);
                    }
          }

          /**
           * this method must be implemented, to provide a different name for
