...
public class Program {
    private byte[][]        main;                //[level in main brach][position in level]
    private byte[][][][]    conditions; //[level in main branch rooted from][level in sub-branch][sub-branch level][position in level in sub-branch]
